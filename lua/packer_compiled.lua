...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/Users/pratik/.config/nvim/pack/packer/start/cmp-cmdline",
  ...
  ["rose-pine"] = {
    ...
    loaded = true,
    path = "/Users/pratik/.config/nvim/pack/packer/start/rose-pine",
  ...
  ["telescope-node-modules.nvim"] = {
    loaded = true,
    path = "/Users/pratik/.config/nvim/pack/packer/start/telescope-node-modules.nvim",
    url = "https://github.com/nvim-telescope/telescope-node-modules.nvim"
  },
  ["telescope-npm.nvim"] = {
    loaded = true,
    path = "/Users/pratik/.config/nvim/pack/packer/start/telescope-npm.nvim",
